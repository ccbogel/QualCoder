...
echo "Please wait ..."
python3 -m pip install Ebooklib pydub SpeechRecognition pdfminer.six python-vlc rispy wordcloud xmlschema
...
echo "and via python's pip these packages were installed: Ebooklib pydub SpeechRecognition pdfminer.six rispy wordcloud xmlschema python-vlc"
