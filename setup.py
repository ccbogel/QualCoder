...
OPTIONS = {"argv_emulation": True, "iconfile": "src/qualcoder/GUI/qualcoder.icns"}
...
# older code above the bracket:  app=[mainscript],
    ...
    extra_options = dict(
        ...
        entry_points={"console_scripts": ["qualcoder=qualcoder.__main__:gui"]},
    )
