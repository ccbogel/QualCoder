# Form implementation generated from reading ui file '/home/qwerty/Bureau/QualCoder-removehtml/src/GUI_UIs/ui_report_compare_coder_file.ui'
#
...
class Ui_Dialog_reportCompareCoderFile(object):
    def setupUi(self, Dialog_reportCompareCoderFile):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=Dialog_reportCompareCoderFile)
        ...
        self.comboBox_coders.setGeometry(QtCore.QRect(50, 30, 211, 28))
        self.comboBox_coders.setObjectName("comboBox_coders")
        self.label_title = QtWidgets.QLabel(parent=self.groupBox)
        self.label_title.setGeometry(QtCore.QRect(10, 0, 291, 24))
        self.label_title.setObjectName("label_title")
        self.label_selections = QtWidgets.QLabel(parent=self.groupBox)
        self.label_selections.setGeometry(QtCore.QRect(270, 30, 400, 28))
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=Dialog_reportCompareCoderFile)
    ...
    def retranslateUi(self, Dialog_reportCompareCoderFile):
        ...
        self.label_coders.setToolTip(_translate("Dialog_reportCompareCoderFile", "Coders"))
        self.comboBox_coders.setToolTip(_translate("Dialog_reportCompareCoderFile", "Select two coders"))
...
"Select two coders, one file, one code."))
        ...
        self.pushButton_clear.setToolTip(_translate("Dialog_reportCompareCoderFile", "Clear selection"))
