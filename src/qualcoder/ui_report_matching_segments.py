# Form implementation generated from reading ui file '/home/qwerty/Bureau/QualCoder-removehtml/src/GUI_UIs/ui_report_matching_segments.ui'
#
...
class Ui_DialogMatchingTextSegments(object):
    def setupUi(self, DialogMatchingTextSegments):
        ...
        self.comboBox_coders.setGeometry(QtCore.QRect(410, 30, 190, 26))
        self.comboBox_coders.setObjectName("comboBox_coders")
        self.label_title = QtWidgets.QLabel(parent=self.groupBox)
        self.label_title.setGeometry(QtCore.QRect(10, 2, 291, 26))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.label_coder.setGeometry(QtCore.QRect(370, 30, 30, 28))
        ...
        self.checkBox_any_matches.setGeometry(QtCore.QRect(400, 63, 621, 41))
        ...
        self.checkBox_one_line.setGeometry(QtCore.QRect(630, 40, 281, 20))
        ...
        self.pushButton_file_filter.setGeometry(QtCore.QRect(630, 2, 32, 32))
    ...
    def retranslateUi(self, DialogMatchingTextSegments):
        ...
        self.label_include.setToolTip(_translate("DialogMatchingTextSegments", "Coded text filter. Must include this text."))
        self.lineEdit_include.setToolTip(_translate("DialogMatchingTextSegments", "Coded text filter. Must include this text."))
