# Form implementation generated from reading ui file '/home/qwerty/Bureau/QualCoder-removehtml/src/GUI_UIs/ui_ai_edit_prompts.ui'
#
...
if __name__ == "__main__":
    ...
    Dialog_AiPrompts = QtWidgets.QDialog()
    ui = Ui_Dialog_AiPrompts()
    ui.setupUi(Dialog_AiPrompts)
    Dialog_AiPrompts.show()
    sys.exit(app.exec())
