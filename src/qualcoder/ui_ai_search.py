# Form implementation generated from reading ui file '/home/qwerty/Bureau/QualCoder-removehtml/src/GUI_UIs/ui_ai_search.ui'
#
...
class Ui_Dialog_AiSearch(object):
    def setupUi(self, Dialog_AiSearch):
        ...
        self.widget_coder = QtWidgets.QWidget(parent=self.tab_code_search)
        self.widget_coder.setObjectName("widget_coder")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.widget_coder)
        ...
        self.horizontalLayout_5.addWidget(self.label_coder)
        spacerItem = QtWidgets.QSpacerItem(9, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.horizontalLayout_5.addWidget(self.pushButton_coder)
        self.verticalLayout_2.addWidget(self.widget_coder)
    ...
    def retranslateUi(self, Dialog_AiSearch):
        ...
        self.label_coder.setText(_translate("Dialog_AiSearch", "TextLabel"))
        self.pushButton_coder.setText(_translate("Dialog_AiSearch", "Select coders"))
...
if __name__ == "__main__":
    ...
    Dialog_AiSearch = QtWidgets.QDialog()
    ui = Ui_Dialog_AiSearch()
    ui.setupUi(Dialog_AiSearch)
    Dialog_AiSearch.show()
    sys.exit(app.exec())
