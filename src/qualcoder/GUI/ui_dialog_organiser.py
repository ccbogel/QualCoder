# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_dialog_organiser.ui'
#
...
class Ui_DialogOrganiser(object):
    def setupUi(self, DialogOrganiser):
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(190, 3, 28, 28))
        ...
        self.pushButton_apply.setGeometry(QtCore.QRect(250, 3, 91, 28))
        self.pushButton_apply.setObjectName("pushButton_apply")
        self.pushButton_create_code = QtWidgets.QPushButton(parent=self.groupBox_header)
        self.pushButton_create_code.setGeometry(QtCore.QRect(100, 3, 28, 28))
        self.pushButton_create_code.setText("")
        self.pushButton_create_code.setObjectName("pushButton_create_code")
        self.pushButton_import_codebook = QtWidgets.QPushButton(parent=self.groupBox_header)
        self.pushButton_import_codebook.setGeometry(QtCore.QRect(130, 3, 28, 28))
        self.pushButton_import_codebook.setText("")
        self.pushButton_import_codebook.setObjectName("pushButton_import_codebook")
        ...
        DialogOrganiser.setTabOrder(self.pushButton_create_category, self.pushButton_create_code)
        DialogOrganiser.setTabOrder(self.pushButton_create_code, self.pushButton_import_codebook)
        DialogOrganiser.setTabOrder(self.pushButton_import_codebook, self.pushButton_export)
    ...
    def retranslateUi(self, DialogOrganiser):
        ...
        self.pushButton_create_category.setToolTip(_translate("DialogOrganiser", "Create category"))
        ...
        self.pushButton_apply.setToolTip(_translate("DialogOrganiser", "Apply changed structure.\n"
