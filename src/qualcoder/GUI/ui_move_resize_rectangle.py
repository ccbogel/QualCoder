# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_move_resize_rectangle.ui'
#
...
class Ui_Dialog_move_resize_rect(object):
    def setupUi(self, Dialog_move_resize_rect):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=Dialog_move_resize_rect)
        self.buttonBox.setGeometry(QtCore.QRect(290, 200, 201, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.label = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label.setGeometry(QtCore.QRect(10, 70, 201, 17))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_2.setGeometry(QtCore.QRect(240, 68, 201, 17))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_3.setGeometry(QtCore.QRect(10, 136, 201, 17))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_4.setGeometry(QtCore.QRect(237, 136, 201, 17))
        self.label_4.setObjectName("label_4")
        self.lineEdit_move_horizontal = QtWidgets.QLineEdit(parent=Dialog_move_resize_rect)
        ...
        self.lineEdit_move_vetical = QtWidgets.QLineEdit(parent=Dialog_move_resize_rect)
        ...
        self.lineEdit_resize_horizontal = QtWidgets.QLineEdit(parent=Dialog_move_resize_rect)
        ...
        self.lineEdit_resize_vertical = QtWidgets.QLineEdit(parent=Dialog_move_resize_rect)
        ...
        self.label_5 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_5.setGeometry(QtCore.QRect(91, 94, 67, 17))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_6.setGeometry(QtCore.QRect(320, 90, 67, 17))
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_7.setGeometry(QtCore.QRect(90, 157, 67, 17))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
        self.label_8.setGeometry(QtCore.QRect(320, 160, 67, 17))
        self.label_8.setObjectName("label_8")
        self.label_info = QtWidgets.QLabel(parent=Dialog_move_resize_rect)
