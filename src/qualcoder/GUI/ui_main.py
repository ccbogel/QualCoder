...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_ai_agent = QtWidgets.QWidget()
        self.tab_ai_agent.setObjectName("tab_ai_agent")
        self.tabWidget.addTab(self.tab_ai_agent, "")
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.sidebar)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setSpacing(6)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.sidebar_frame = QtWidgets.QFrame(parent=self.sidebar)
        self.sidebar_frame.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.sidebar_frame.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        self.sidebar_frame.setObjectName("sidebar_frame")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.sidebar_frame)
        ...
        self.menuAI_assisted_analysis = QtWidgets.QMenu(parent=self.menuAnalysis)
        self.menuAI_assisted_analysis.setToolTipsVisible(True)
        self.menuAI_assisted_analysis.setObjectName("menuAI_assisted_analysis")
        ...
        self.actionAI_Agent = QtGui.QAction(parent=MainWindow)
        self.actionAI_Agent.setObjectName("actionAI_Agent")
        ...
        self.actionTaguette_import = QtGui.QAction(parent=MainWindow)
        self.actionTaguette_import.setObjectName("actionTaguette_import")
        self.actionSonal_import = QtGui.QAction(parent=MainWindow)
        self.actionSonal_import.setObjectName("actionSonal_import")
        self.actionAI_Agent_Sidebar = QtGui.QAction(parent=MainWindow)
        self.actionAI_Agent_Sidebar.setCheckable(True)
        self.actionAI_Agent_Sidebar.setObjectName("actionAI_Agent_Sidebar")
        self.actionAsk_the_AI_Agent = QtGui.QAction(parent=MainWindow)
        self.actionAsk_the_AI_Agent.setObjectName("actionAsk_the_AI_Agent")
        self.actionAI_topic_exploration = QtGui.QAction(parent=MainWindow)
        self.actionAI_topic_exploration.setObjectName("actionAI_topic_exploration")
        self.actionAI_text_analysis = QtGui.QAction(parent=MainWindow)
        self.actionAI_text_analysis.setObjectName("actionAI_text_analysis")
        self.actionAI_code_analysis = QtGui.QAction(parent=MainWindow)
        self.actionAI_code_analysis.setObjectName("actionAI_code_analysis")
        self.actionCheck_project_AI_readiness = QtGui.QAction(parent=MainWindow)
        self.actionCheck_project_AI_readiness.setObjectName("actionCheck_project_AI_readiness")
        self.actionUndo_coding = QtGui.QAction(parent=MainWindow)
        self.actionUndo_coding.setObjectName("actionUndo_coding")
        self.actionRedo_coding = QtGui.QAction(parent=MainWindow)
        self.actionRedo_coding.setObjectName("actionRedo_coding")
        ...
        self.menuImport.addAction(self.actionTaguette_import)
        self.menuImport.addAction(self.actionRQDA_Project_import)
        self.menuImport.addAction(self.actionSonal_import)
        ...
        self.menuEdit.addAction(self.actionUndo_coding)
        self.menuEdit.addAction(self.actionRedo_coding)
        ...
        self.menuAI_assisted_analysis.addAction(self.actionAI_topic_exploration)
        self.menuAI_assisted_analysis.addAction(self.actionAI_text_analysis)
        self.menuAI_assisted_analysis.addAction(self.actionAI_code_analysis)
        self.menuAnalysis.addAction(self.actionCoding_reports)
        self.menuAnalysis.addAction(self.actionCode_co_occurrence)
        self.menuAnalysis.addAction(self.actionCode_relations)
        self.menuAnalysis.addAction(self.actionCode_text_exact_matches)
        self.menuAnalysis.addAction(self.actionText_segments_by_codes)
        self.menuAnalysis.addAction(self.actionView_Graph)
        self.menuAnalysis.addAction(self.menuAI_assisted_analysis.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textBrowser_manage.setPlainText(_translate("MainWindow", "Select an option from the Manage menu"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_manage), _translate("MainWindow", "Manage"))
        self.textBrowser_coding.setPlainText(_translate("MainWindow", "Select an option from the coding menu"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_coding), _translate("MainWindow", "Coding"))
        self.textBrowser_reports.setPlainText(_translate("MainWindow", "Select an option from the Analysis or Reports menu"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_reports), _translate("MainWindow", "Reports"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_ai_agent), _translate("MainWindow", "AI Agent"))
        ...
        self.menuAI_assisted_analysis.setTitle(_translate("MainWindow", "AI assisted analysis"))
        ...
        self.actionManage_files.setText(_translate("MainWindow", "Files"))
        self.actionManage_cases.setText(_translate("MainWindow", "Cases"))
        self.actionFile_categories.setText(_translate("MainWindow", "File categories"))
        self.actionManage_journals.setText(_translate("MainWindow", "Journals"))
        ...
        self.actionCoding_reports.setText(_translate("MainWindow", "Code retrieval"))
        ...
        self.actionManage_attributes.setText(_translate("MainWindow", "Attributes"))
        ...
        self.actionView_Graph.setText(_translate("MainWindow", "Graph"))
        ...
        self.actionManage_bad_links_to_files.setText(_translate("MainWindow", "Bad links to files"))
        ...
        self.actionManage_references.setText(_translate("MainWindow", "References"))
        ...
        self.actionMenu_Key_Shortcuts.setText(_translate("MainWindow", "Key Shortcuts"))
        ...
        self.actionAI_Agent.setText(_translate("MainWindow", "AI Agent chat"))
        ...
        self.actionAI_Prompts.setToolTip(_translate("MainWindow", "Edit AI prompts that can be used in various stages of the analysis"))
        ...
        self.actionTaguette_import.setText(_translate("MainWindow", "Taguette import"))
        self.actionSonal_import.setText(_translate("MainWindow", "Sonal import"))
        self.actionAI_Agent_Sidebar.setText(_translate("MainWindow", "Agent sidebar view"))
        self.actionAI_Agent_Sidebar.setToolTip(_translate("MainWindow", "Show the AI agent conversation in a sidebar next to other workspaces"))
        self.actionAsk_the_AI_Agent.setText(_translate("MainWindow", "Ask the AI Agent"))
        self.actionAI_topic_exploration.setText(_translate("MainWindow", "AI topic exploration"))
        self.actionAI_topic_exploration.setToolTip(_translate("MainWindow", "Explore a free-search topic together with the AI agent."))
        self.actionAI_text_analysis.setText(_translate("MainWindow", "AI text analysis"))
        self.actionAI_text_analysis.setToolTip(_translate("MainWindow", "Analyse a piece of text from your empirical data together with the AI."))
        self.actionAI_code_analysis.setText(_translate("MainWindow", "AI code analysis"))
        self.actionAI_code_analysis.setToolTip(_translate("MainWindow", "Analyze the data collected under a certain code together with the AI agent."))
        self.actionCheck_project_AI_readiness.setText(_translate("MainWindow", "Check project AI readiness"))
        self.actionCheck_project_AI_readiness.setToolTip(_translate("MainWindow", "Checks whether the current QualCoder project is well prepared for working with the AI agent and produces a report"))
        self.actionUndo_coding.setText(_translate("MainWindow", "Undo coding"))
        self.actionUndo_coding.setToolTip(_translate("MainWindow", "Undo the last change to codings or to the code tree"))
        self.actionRedo_coding.setText(_translate("MainWindow", "Redo coding"))
        self.actionRedo_coding.setToolTip(_translate("MainWindow", "Redo the last undone change to codings or to the code tree"))
