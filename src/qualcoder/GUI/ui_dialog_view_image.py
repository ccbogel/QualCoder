# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_dialog_view_image.ui'
#
...
class Ui_Dialog_view_image(object):
    def setupUi(self, Dialog_view_image):
        ...
        self.horizontalSlider = QtWidgets.QSlider(parent=Dialog_view_image)
        ...
        self.textEdit = QtWidgets.QTextEdit(parent=Dialog_view_image)
        self.textEdit.setMaximumSize(QtCore.QSize(16777215, 80))
        self.textEdit.setObjectName("textEdit")
        self.gridLayout.addWidget(self.textEdit, 3, 0, 1, 1)
        self.scrollArea = QtWidgets.QScrollArea(parent=Dialog_view_image)
    ...
    def retranslateUi(self, Dialog_view_image):
        ...
        self.textEdit.setToolTip(_translate("Dialog_view_image", "Memo"))
