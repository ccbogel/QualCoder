...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -347, 795, 948))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.comboBox_ai_permissions.addItem("")
        self.comboBox_ai_permissions.addItem("")
        self.gridLayout_6.addWidget(self.comboBox_ai_permissions, 6, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.toolButtonShowApiKey, 5, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.label_ai_model_desc, 3, 2, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.pushButton_ai_profile_edit, 0, 3, 1, 1)
...
""))
        ...
        self.label_12.setText(_translate("Dialog_settings", "More Info:"))
