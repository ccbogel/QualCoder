...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 787, 1074))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
""))
        ...
        self.comboBox_AI_model_fast.setProperty("placeholderText", _translate("Dialog_settings", "<select available model>"))
        ...
        self.comboBox_AI_model_large.setProperty("placeholderText", _translate("Dialog_settings", "<select available model>"))
