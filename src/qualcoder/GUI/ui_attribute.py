# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_attribute.ui'
#
...
class Ui_DialogAddAttribute(object):
    def setupUi(self, DialogAddAttribute):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DialogAddAttribute)
        self.buttonBox.setGeometry(QtCore.QRect(30, 160, 341, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.label_att_name = QtWidgets.QLabel(parent=DialogAddAttribute)
        self.label_att_name.setGeometry(QtCore.QRect(50, 10, 301, 28))
        self.label_att_name.setObjectName("label_att_name")
        self.lineEdit_name = QtWidgets.QLineEdit(parent=DialogAddAttribute)
        self.lineEdit_name.setGeometry(QtCore.QRect(50, 40, 241, 25))
        self.lineEdit_name.setObjectName("lineEdit_name")
        self.radioButton_character = QtWidgets.QRadioButton(parent=DialogAddAttribute)
        ...
        self.radioButton_numeric = QtWidgets.QRadioButton(parent=DialogAddAttribute)
