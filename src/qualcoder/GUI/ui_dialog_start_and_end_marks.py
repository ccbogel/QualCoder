# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_dialog_start_and_end_marks.ui'
#
...
class Ui_Dialog_StartAndEndMarks(object):
    def setupUi(self, Dialog_StartAndEndMarks):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=Dialog_StartAndEndMarks)
        ...
        self.lineEdit_endmark = QtWidgets.QLineEdit(parent=self.groupBox)
        self.lineEdit_endmark.setGeometry(QtCore.QRect(150, 120, 221, 27))
        self.lineEdit_endmark.setObjectName("lineEdit_endmark")
        self.lineEdit_startmark = QtWidgets.QLineEdit(parent=self.groupBox)
        ...
        self.label_startmark = QtWidgets.QLabel(parent=self.groupBox)
        self.label_startmark.setGeometry(QtCore.QRect(10, 80, 131, 17))
        self.label_startmark.setObjectName("label_startmark")
        self.label_endmark = QtWidgets.QLabel(parent=self.groupBox)
