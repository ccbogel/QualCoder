...
class Ui_DialogMatchingTextSegments(object):
    def setupUi(self, DialogMatchingTextSegments):
        ...
        self.comboBox_coders.setGeometry(QtCore.QRect(500, 30, 190, 26))
        self.comboBox_coders.setObjectName("comboBox_coders")
        self.label_title = QtWidgets.QLabel(parent=self.groupBox)
        self.label_title.setGeometry(QtCore.QRect(10, 1, 291, 26))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.checkBox_any_matches.setGeometry(QtCore.QRect(360, 63, 621, 31))
        ...
        self.checkBox_one_line.setGeometry(QtCore.QRect(700, 40, 211, 20))
        ...
        self.pushButton_file_filter.setGeometry(QtCore.QRect(700, 2, 32, 32))
