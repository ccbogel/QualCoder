...
class Ui_Dialog_code_av(object):
    def setupUi(self, Dialog_code_av):
        ...
        self.label_segment.setGeometry(QtCore.QRect(280, 50, 241, 28))
        self.label_segment.setObjectName("label_segment")
        self.label_coder = QtWidgets.QLabel(parent=self.groupBox_2)
        self.label_coder.setGeometry(QtCore.QRect(0, 50, 241, 28))
        ...
        self.checkBox_scroll_transcript.setGeometry(QtCore.QRect(570, 51, 301, 28))
