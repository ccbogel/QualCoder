# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_save_query.ui'
#
...
class Ui_DialogSaveQuery(object):
    def setupUi(self, DialogSaveQuery):
        ...
        self.label_name = QtWidgets.QLabel(parent=DialogSaveQuery)
        self.label_name.setObjectName("label_name")
        self.verticalLayout.addWidget(self.label_name)
        self.lineEdit_name = QtWidgets.QLineEdit(parent=DialogSaveQuery)
        self.lineEdit_name.setObjectName("lineEdit_name")
        self.verticalLayout.addWidget(self.lineEdit_name)
        self.label = QtWidgets.QLabel(parent=DialogSaveQuery)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.lineEdit_group = QtWidgets.QLineEdit(parent=DialogSaveQuery)
        self.lineEdit_group.setObjectName("lineEdit_group")
        self.verticalLayout.addWidget(self.lineEdit_group)
        self.label_2 = QtWidgets.QLabel(parent=DialogSaveQuery)
        self.label_2.setObjectName("label_2")
        self.verticalLayout.addWidget(self.label_2)
        self.textEdit = QtWidgets.QTextEdit(parent=DialogSaveQuery)
        self.textEdit.setMinimumSize(QtCore.QSize(0, 60))
        self.textEdit.setMaximumSize(QtCore.QSize(16777215, 800))
        self.textEdit.setObjectName("textEdit")
        self.verticalLayout.addWidget(self.textEdit)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DialogSaveQuery)
