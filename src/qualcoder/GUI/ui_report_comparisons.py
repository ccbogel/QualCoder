# Form implementation generated from reading ui file 'ui_report_comparisons.ui'
#
...
class Ui_Dialog_reportComparisons(object):
    def setupUi(self, Dialog_reportComparisons):
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(360, 27, 32, 32))
        self.pushButton_export.setText("")
        self.pushButton_export.setObjectName("pushButton_export")
        self.pushButton_run = QtWidgets.QPushButton(parent=self.groupBox)
        self.pushButton_run.setGeometry(QtCore.QRect(280, 27, 32, 32))
        self.pushButton_run.setText("")
        self.pushButton_run.setObjectName("pushButton_run")
        self.label_coders = QtWidgets.QLabel(parent=self.groupBox)
        self.label_coders.setGeometry(QtCore.QRect(10, 30, 32, 28))
        self.label_coders.setMinimumSize(QtCore.QSize(32, 28))
        self.label_coders.setMaximumSize(QtCore.QSize(32, 28))
        self.label_coders.setText("")
        self.label_coders.setObjectName("label_coders")
        self.comboBox_coders = QtWidgets.QComboBox(parent=self.groupBox)
        self.comboBox_coders.setGeometry(QtCore.QRect(50, 27, 221, 32))
        self.comboBox_coders.setObjectName("comboBox_coders")
        self.pushButton_clear = QtWidgets.QPushButton(parent=self.groupBox)
        self.pushButton_clear.setGeometry(QtCore.QRect(320, 27, 32, 32))
        ...
        self.pushButton_help1.setGeometry(QtCore.QRect(400, 27, 32, 32))
    ...
    def retranslateUi(self, Dialog_reportComparisons):
        ...
        self.pushButton_export.setToolTip(_translate("Dialog_reportComparisons", "Export Excel"))
        self.pushButton_run.setToolTip(_translate("Dialog_reportComparisons", "Run comparison"))
        self.label_coders.setToolTip(_translate("Dialog_reportComparisons", "Coder"))
        self.comboBox_coders.setToolTip(_translate("Dialog_reportComparisons", "Select two coders"))
        self.pushButton_clear.setToolTip(_translate("Dialog_reportComparisons", "Clear selection"))
