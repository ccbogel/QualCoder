...
class Ui_Dialog_view_av(object):
    def setupUi(self, Dialog_view_av):
        ...
        self.pushButton_case_sensitive = QtWidgets.QPushButton(parent=self.groupBox_search_text)
        self.pushButton_case_sensitive.setGeometry(QtCore.QRect(210, 3, 28, 28))
        self.pushButton_case_sensitive.setText("")
        self.pushButton_case_sensitive.setObjectName("pushButton_case_sensitive")
    ...
    def retranslateUi(self, Dialog_view_av):
        ...
        self.pushButton_play.setToolTip(_translate("Dialog_view_av", "Ctrl + S start/pause\n"
"Ctrl + P start/pause"))
        ...
        self.pushButton_rate_down.setToolTip(_translate("Dialog_view_av", "Decrease play rate. Ctrl + Shift + &lt; "))
        self.pushButton_rate_up.setToolTip(_translate("Dialog_view_av", "Increase play rate. Ctrl + Shift + &gt;"))
        self.pushButton_rewind_5.setToolTip(_translate("Dialog_view_av", "Rewind 5 seconds Ctrl + R"))
        self.pushButton_rewind_30.setToolTip(_translate("Dialog_view_av", "Rewind 30 seconds. Alt + Minus"))
...
"red underline = Assigned to code or annotation"))
        ...
        self.pushButton_case_sensitive.setToolTip(_translate("Dialog_view_av", "Case sensitive"))
