# Form implementation generated from reading ui file 'C:\Users\salom\Downloads\r6\_ui_backup_20260826_012531\ui_dialog_code_colours.ui'
#
...
class Ui_Dialog_code_colors(object):
    def setupUi(self, Dialog_code_colors):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=Dialog_code_colors)
        ...
        self.pushButton_undo = QtWidgets.QPushButton(parent=self.groupBox_2)
        self.pushButton_undo.setGeometry(QtCore.QRect(620, 10, 30, 30))
        self.pushButton_undo.setText("")
        self.pushButton_undo.setObjectName("pushButton_undo")
        self.gridLayout.addWidget(self.groupBox_2, 0, 0, 1, 1)
        self.groupBox = QtWidgets.QGroupBox(parent=Dialog_code_colors)
        ...
        self.pushButton_clear_selection_codes = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        self.pushButton_apply = QtWidgets.QPushButton(parent=self.groupBox_3)
        ...
        self.label_perspective = QtWidgets.QLabel(parent=self.scrollAreaWidgetContents)
        self.label_perspective.setObjectName("label_perspective")
        self.gridLayout_3.addWidget(self.label_perspective, 0, 0, 1, 1)
        self.pushButton_clear_selection = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
        ...
        self.pushButton_perspective = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents)
    ...
    def retranslateUi(self, Dialog_code_colors):
        ...
        self.label_coded_area_icon.setToolTip(_translate("Dialog_code_colors", "This coded area"))
        self.label.setText(_translate("Dialog_code_colors", "Codes colour scheme. Select colours in order. Select codes. Apply."))
        self.pushButton_undo.setToolTip(_translate("Dialog_code_colors", "Undo all changes."))
