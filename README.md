...
There may be some issues with the installation and running of QualCoder3.6 AI version over then next days or weeks. Please use the recent release (3.5 version) from the above link to the Releases page if you are running into difficulties with this latest update.**
