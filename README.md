...
It is best to download the Current Release form the Releases page. Occassional errors can occur in this latest code. There is currently an error in the Manage Files table dispay of attributes.
