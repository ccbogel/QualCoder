...
It is best to download the Current Release form the Releases page. Occassional errors can occur in this latest code. **There was an error in the Manage Files and Cases table table dispay of attributes during the week March to first week April, fixed 8 April. So if you downloaded latest code during this time, download again and install again!**
