...
sudo apt install python3-pip python3-pyqt5 python3-lxml python3-pil python3-pdfminer vlc python3-ebooklib python3-ply python3-six python3-chardet
echo "Please wait ..."
sudo python3 -m pip install pdfminer.six openpyxl pydub SpeechRecognition
