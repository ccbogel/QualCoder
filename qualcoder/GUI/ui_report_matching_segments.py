...
class Ui_DialogMatchingTextSegments(object):
    def setupUi(self, DialogMatchingTextSegments):
        ...
        self.label_title.setGeometry(QtCore.QRect(10, -1, 291, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_instructions.setGeometry(QtCore.QRect(5, 34, 300, 51))
        ...
        DialogMatchingTextSegments.setTabOrder(self.pushButton_run, self.pushButton_export_odt)
        DialogMatchingTextSegments.setTabOrder(self.pushButton_export_odt, self.listWidget_files)
    ...
    def retranslateUi(self, DialogMatchingTextSegments):
        ...
        self.pushButton_export_odt.setToolTip(_translate("DialogMatchingTextSegments", "Export ODT file"))
        ...
        self.label_exclude.setText(_translate("DialogMatchingTextSegments", "Exclude text"))
        self.label_instructions.setText(_translate("DialogMatchingTextSegments", "Select 1 file, 1 coder. Select 2 or more codes. Can exclude results by excluding an overlapping code."))
