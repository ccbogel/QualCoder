...
class Ui_Dialog_CodeCrossovers(object):
    def setupUi(self, Dialog_CodeCrossovers):
        ...
        self.label_1.setGeometry(QtCore.QRect(10, -4, 201, 26))
        ...
        self.pushButton_exportcsv.setGeometry(QtCore.QRect(360, 30, 291, 31))
        ...
        self.pushButton_calculate.setGeometry(QtCore.QRect(10, 30, 171, 31))
        self.pushButton_calculate.setObjectName("pushButton_calculate")
        self.label_codes = QtWidgets.QLabel(self.groupBox)
        self.label_codes.setGeometry(QtCore.QRect(10, 70, 641, 28))
