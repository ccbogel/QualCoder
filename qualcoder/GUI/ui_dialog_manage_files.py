...
class Ui_Dialog_manage_files(object):
    def setupUi(self, Dialog_manage_files):
        ...
        self.pushButton_view.setGeometry(QtCore.QRect(10, 10, 91, 31))
        self.pushButton_view.setObjectName("pushButton_view")
        self.pushButton_create = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_create.setGeometry(QtCore.QRect(230, 10, 101, 31))
        self.pushButton_create.setObjectName("pushButton_create")
        self.pushButton_export = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_export.setGeometry(QtCore.QRect(230, 47, 101, 31))
        self.pushButton_export.setObjectName("pushButton_export")
        self.pushButton_delete = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_delete.setGeometry(QtCore.QRect(340, 47, 201, 31))
        self.pushButton_delete.setObjectName("pushButton_delete")
        self.pushButton_import = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_import.setGeometry(QtCore.QRect(110, 10, 111, 31))
        self.pushButton_import.setObjectName("pushButton_import")
        self.pushButton_add_attribute = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_add_attribute.setGeometry(QtCore.QRect(340, 10, 201, 31))
        ...
        self.pushButton_link.setGeometry(QtCore.QRect(110, 47, 111, 31))
    ...
    def retranslateUi(self, Dialog_manage_files):
        ...
        self.pushButton_link.setText(_translate("Dialog_manage_files", "Link"))
