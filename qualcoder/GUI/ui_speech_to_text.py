...
class Ui_DialogSpeechToText(object):
    def setupUi(self, DialogSpeechToText):
        ...
        self.label_ffmpeg_info.setGeometry(QtCore.QRect(20, 260, 571, 22))
        ...
        self.progressBar.setGeometry(QtCore.QRect(64, 345, 411, 23))
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.pushButton_start = QtWidgets.QPushButton(DialogSpeechToText)
        self.pushButton_start.setGeometry(QtCore.QRect(20, 340, 32, 32))
        ...
        self.label_process.setGeometry(QtCore.QRect(20, 303, 661, 17))
