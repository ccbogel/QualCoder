...
class Ui_DialogSpeechToText(object):
    def setupUi(self, DialogSpeechToText):
        ...
        self.label_ffmpeg_info.setGeometry(QtCore.QRect(20, 270, 571, 17))
        ...
        self.label_process.setGeometry(QtCore.QRect(130, 303, 561, 17))
    ...
    def retranslateUi(self, DialogSpeechToText):
        ...
        self.label_ffmpeg_info.setText(_translate("DialogSpeechToText", "Speech to text requires installed software: ffmpg"))
...
"en-AU"))
        ...
        self.pushButton_start.setText(_translate("DialogSpeechToText", "Start"))
        ...
        self.comboBox_chunksize.setItemText(0, _translate("DialogSpeechToText", "30 seconds"))
        self.comboBox_chunksize.setItemText(1, _translate("DialogSpeechToText", "60 seconds"))
