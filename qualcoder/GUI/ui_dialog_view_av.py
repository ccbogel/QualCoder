...
class Ui_Dialog_view_av(object):
    def setupUi(self, Dialog_view_av):
        ...
        self.checkBox_scroll_transcript.setGeometry(QtCore.QRect(200, 61, 511, 22))
        self.checkBox_scroll_transcript.setObjectName("checkBox_scroll_transcript")
        self.label_rate = QtWidgets.QLabel(self.groupBox_2)
        self.label_rate.setGeometry(QtCore.QRect(10, 60, 111, 17))
    ...
    def retranslateUi(self, Dialog_view_av):
        ...
        self.pushButton_play.setToolTip(_translate("Dialog_view_av", "<html><head/><body><p>Ctrl + R rewind 5 seconds</p><p>Alt + R rewind 30 seconds</p><p>Alt + F forward 30 seconds</p><p>Ctrl + S start/pause</p><p>Ctrl + P start/pause</p><p>Ctrl + Shift + &gt; increase play rate, maximum 2.0</p><p>Ctrl + Shift + &lt; decrease play rate, minimum 0.1</p></body></html>"))
        ...
        self.label_rate.setText(_translate("Dialog_view_av", "Rate:"))
