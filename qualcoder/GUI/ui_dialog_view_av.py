...
class Ui_Dialog_view_av(object):
    def setupUi(self, Dialog_view_av):
        ...
        self.pushButton_speechtotext = QtWidgets.QPushButton(self.groupBox_search_text)
        self.pushButton_speechtotext.setEnabled(False)
        self.pushButton_speechtotext.setGeometry(QtCore.QRect(430, 3, 28, 28))
        self.pushButton_speechtotext.setText("")
        self.pushButton_speechtotext.setObjectName("pushButton_speechtotext")
        self.gridLayout.addWidget(self.groupBox_search_text, 6, 0, 1, 1)
        self.label_note = QtWidgets.QLabel(Dialog_view_av)
...
"red underline = Assigned to code or annotation"))
        ...
        self.pushButton_speechtotext.setToolTip(_translate("Dialog_view_av", "Convert speech to text using online service"))
