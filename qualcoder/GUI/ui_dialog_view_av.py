...
class Ui_Dialog_view_av(object):
    def setupUi(self, Dialog_view_av):
        ...
        self.horizontalSlider_vol.setGeometry(QtCore.QRect(590, 21, 160, 18))
        ...
        self.label_volume.setGeometry(QtCore.QRect(540, 8, 32, 32))
        ...
        self.comboBox_tracks.setGeometry(QtCore.QRect(830, 14, 61, 28))
        self.comboBox_tracks.setObjectName("comboBox_tracks")
        self.label_audio = QtWidgets.QLabel(self.groupBox_2)
        self.label_audio.setGeometry(QtCore.QRect(760, 17, 61, 20))
        ...
        self.label_rate.setGeometry(QtCore.QRect(448, 17, 41, 20))
        self.label_rate.setObjectName("label_rate")
        self.label_time_3 = QtWidgets.QLabel(self.groupBox_2)
        self.label_time_3.setGeometry(QtCore.QRect(180, 7, 32, 32))
        ...
        self.label_search_regex.setGeometry(QtCore.QRect(0, 5, 32, 32))
