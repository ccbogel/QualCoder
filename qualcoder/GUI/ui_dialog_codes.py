...
class Ui_Dialog_codes(object):
    def setupUi(self, Dialog_codes):
        ...
        self.label_coded.setGeometry(QtCore.QRect(780, 70, 361, 28))
        ...
        self.checkBox_search_escaped.setGeometry(QtCore.QRect(660, 70, 101, 22))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.listWidgetLinks.sizePolicy().hasHeightForWidth())
        self.listWidgetLinks.setSizePolicy(sizePolicy)
    ...
    def retranslateUi(self, Dialog_codes):
        ...
        self.label_coded.setText(_translate("Dialog_codes", "Right click to mark and unmark selected text"))
        ...
        self.checkBox_search_case.setToolTip(_translate("Dialog_codes", "<html><head/><body><p>search case sensitive</p></body></html>"))
        self.checkBox_search_case.setText(_translate("Dialog_codes", "Case"))
        self.checkBox_search_all_files.setToolTip(_translate("Dialog_codes", "<html><head/><body><p>search all files</p></body></html>"))
        self.checkBox_search_all_files.setText(_translate("Dialog_codes", "All"))
        self.checkBox_search_escaped.setToolTip(_translate("Dialog_codes", "<html><head/><body><p>Search escaped (no special regex characters)</p></body></html>"))
        self.checkBox_search_escaped.setText(_translate("Dialog_codes", "Escaped"))
