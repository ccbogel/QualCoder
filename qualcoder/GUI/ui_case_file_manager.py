...
class Ui_Dialog_case_file_manager(object):
    def setupUi(self, Dialog_case_file_manager):
        ...
        self.label_case.setGeometry(QtCore.QRect(0, -10, 881, 32))
        ...
        self.label_file.setGeometry(QtCore.QRect(0, 20, 881, 30))
        self.label_file.setMinimumSize(QtCore.QSize(0, 30))
        self.label_file.setMaximumSize(QtCore.QSize(16777215, 30))
