...
class Ui_Dialog_code_by_case(object):
    def setupUi(self, Dialog_code_by_case):
        ...
        self.label_file_totals = QtWidgets.QLabel(self.groupBox)
        self.label_file_totals.setGeometry(QtCore.QRect(93, 44, 901, 22))
        self.label_file_totals.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_file_totals.setObjectName("label_file_totals")
        self.pushButton_next_file = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_next_file.setGeometry(QtCore.QRect(50, 40, 28, 28))
        self.pushButton_next_file.setText("")
        self.pushButton_next_file.setObjectName("pushButton_next_file")
        self.pushButton_previous_file = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_previous_file.setGeometry(QtCore.QRect(10, 40, 28, 28))
        self.pushButton_previous_file.setText("")
        self.pushButton_previous_file.setObjectName("pushButton_previous_file")
...
"<p>Right-click to change automatic searching options</p></body></html>"))
        ...
        self.label_file_totals.setText(_translate("Dialog_code_by_case", "0 / 0"))
        self.pushButton_next_file.setToolTip(_translate("Dialog_code_by_case", "Next file segment for this case"))
        self.pushButton_previous_file.setToolTip(_translate("Dialog_code_by_case", "Previous file segment for this case"))
        self.pushButton_latest.setToolTip(_translate("Dialog_code_by_case", "Case with latest coding"))
        self.pushButton_next_2.setToolTip(_translate("Dialog_code_by_case", "Next Case"))
        self.label_case.setText(_translate("Dialog_code_by_case", "."))
        self.pushButton_goto_id.setToolTip(_translate("Dialog_code_by_case", "Go to case id"))
