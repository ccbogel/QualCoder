...
class Ui_Dialog_code_av(object):
    def setupUi(self, Dialog_code_av):
        ...
        Dialog_code_av.resize(1027, 596)
        ...
        self.pushButton_play.setGeometry(QtCore.QRect(10, 10, 36, 36))
        self.pushButton_play.setText("")
        self.pushButton_play.setObjectName("pushButton_play")
        self.horizontalSlider_vol = QtWidgets.QSlider(self.groupBox_2)
        self.horizontalSlider_vol.setGeometry(QtCore.QRect(720, 19, 160, 18))
        ...
        self.label_volume.setGeometry(QtCore.QRect(678, 10, 32, 32))
        ...
        self.label_time.setGeometry(QtCore.QRect(400, 15, 131, 21))
        self.label_time.setText("")
        self.label_time.setObjectName("label_time")
        self.pushButton_coding = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_coding.setGeometry(QtCore.QRect(170, 11, 181, 36))
        ...
        self.pushButton_rewind_30.setGeometry(QtCore.QRect(90, 10, 36, 36))
        ...
        self.pushButton_forward_30.setGeometry(QtCore.QRect(130, 10, 36, 36))
        ...
        self.pushButton_rate_down.setGeometry(QtCore.QRect(538, 10, 36, 36))
        ...
        self.pushButton_rate_up.setGeometry(QtCore.QRect(620, 10, 36, 36))
        ...
        self.pushButton_rewind_5.setGeometry(QtCore.QRect(50, 10, 36, 36))
        ...
        self.graphicsView.setMinimumSize(QtCore.QSize(990, 0))
        self.graphicsView.setMaximumSize(QtCore.QSize(990, 120))
    ...
    def retranslateUi(self, Dialog_code_av):
        ...
        self.pushButton_rewind_30.setToolTip(_translate("Dialog_code_av", "<html><head/><body><p>Rewind 30 seconds</p><p>Alt + R</p></body></html>"))
        self.pushButton_forward_30.setToolTip(_translate("Dialog_code_av", "<html><head/><body><p>Forward 30 seconds</p><p>Alt + F</p></body></html>"))
        ...
        self.pushButton_rewind_5.setToolTip(_translate("Dialog_code_av", "<html><head/><body><p>Rewind 5 seconds</p><p>Ctrl + R</p></body></html>"))
