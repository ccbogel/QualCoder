...
class Ui_Dialog_code_av(object):
    def setupUi(self, Dialog_code_av):
        ...
        self.pushButton_play.setGeometry(QtCore.QRect(10, 12, 81, 27))
        ...
        self.label_volume.setGeometry(QtCore.QRect(630, 18, 81, 20))
        ...
        self.checkBox_scroll_transcript.setGeometry(QtCore.QRect(550, 50, 541, 22))
        self.checkBox_scroll_transcript.setObjectName("checkBox_scroll_transcript")
        self.label_rate = QtWidgets.QLabel(self.groupBox_2)
        self.label_rate.setGeometry(QtCore.QRect(570, 19, 81, 17))
