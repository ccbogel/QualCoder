...
class Ui_Dialog_file_summary(object):
    def setupUi(self, Dialog_file_summary):
        ...
        self.groupBox.setMaximumSize(QtCore.QSize(16777215, 34))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.label_search_results = QtWidgets.QLabel(self.groupBox)
        self.label_search_results.setGeometry(QtCore.QRect(330, 0, 181, 20))
        ...
        self.lineEdit_search_results.setGeometry(QtCore.QRect(511, -2, 181, 28))
        ...
        self.pushButton_search_next.setGeometry(QtCore.QRect(699, -2, 28, 28))
        ...
        self.label_files.setGeometry(QtCore.QRect(0, 0, 281, 22))
    ...
    def retranslateUi(self, Dialog_file_summary):
        ...
        self.label_search_results.setText(_translate("Dialog_file_summary", "Search Results for:"))
