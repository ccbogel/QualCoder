...
class Ui_Dialog_reportComparisons(object):
    def setupUi(self, Dialog_reportComparisons):
        ...
        self.pushButton_exporttext.setGeometry(QtCore.QRect(400, 27, 32, 32))
    ...
    def retranslateUi(self, Dialog_reportComparisons):
        ...
        self.pushButton_exporttext.setToolTip(_translate("Dialog_reportComparisons", "<html><head/><body><p>Export text file</p></body></html>"))
