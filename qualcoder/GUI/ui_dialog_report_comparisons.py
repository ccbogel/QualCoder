...
class Ui_Dialog_reportComparisons(object):
    def setupUi(self, Dialog_reportComparisons):
        ...
        Dialog_reportComparisons.setTabOrder(self.pushButton_clear, self.pushButton_exporttext)
        Dialog_reportComparisons.setTabOrder(self.pushButton_exporttext, self.pushButton_help1)
