...
class Ui_Dialog_reportComparisons(object):
    def setupUi(self, Dialog_reportComparisons):
        ...
        self.pushButton_exporttext.setGeometry(QtCore.QRect(420, 27, 36, 36))
        ...
        self.pushButton_run.setGeometry(QtCore.QRect(320, 27, 36, 36))
        ...
        self.pushButton_clear.setGeometry(QtCore.QRect(370, 27, 36, 36))
