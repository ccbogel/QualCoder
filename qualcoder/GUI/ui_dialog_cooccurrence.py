...
class Ui_Dialog_Coocurrence(object):
    def setupUi(self, Dialog_Coocurrence):
        ...
        self.label_selections.setGeometry(QtCore.QRect(10, 3, 221, 22))
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(330, 1, 32, 32))
        ...
        self.checkBox_hide_blanks.setGeometry(QtCore.QRect(240, 40, 201, 20))
        ...
        self.pushButton_run.setGeometry(QtCore.QRect(240, 0, 32, 32))
        self.pushButton_run.setMinimumSize(QtCore.QSize(32, 32))
        self.pushButton_run.setMaximumSize(QtCore.QSize(32, 32))
    ...
    def retranslateUi(self, Dialog_Coocurrence):
        ...
        self.pushButton_run.setToolTip(_translate("Dialog_Coocurrence", "<html><head/><body><p>Run</p></body></html>"))
