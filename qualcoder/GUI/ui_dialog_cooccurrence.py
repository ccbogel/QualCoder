...
class Ui_Dialog_Coocurrence(object):
    def setupUi(self, Dialog_Coocurrence):
        ...
        self.label_selections.setGeometry(QtCore.QRect(10, 3, 151, 22))
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(450, 1, 32, 32))
        ...
        self.checkBox_hide_blanks.setGeometry(QtCore.QRect(170, 4, 151, 20))
        ...
        self.pushButton_select_files.setGeometry(QtCore.QRect(330, 1, 32, 32))
        ...
        self.pushButton_select_categories.setGeometry(QtCore.QRect(410, 1, 32, 32))
        ...
        self.pushButton_select_codes.setGeometry(QtCore.QRect(370, 1, 32, 32))
    ...
    def retranslateUi(self, Dialog_Coocurrence):
        ...
        self.pushButton_select_files.setToolTip(_translate("Dialog_Coocurrence", "<html><head/><body><p>Select files</p></body></html>"))
        self.pushButton_select_categories.setToolTip(_translate("Dialog_Coocurrence", "<html><head/><body><p>Select categories</p></body></html>"))
        self.pushButton_select_codes.setToolTip(_translate("Dialog_Coocurrence", "<html><head/><body><p>Select codes</p></body></html>"))
