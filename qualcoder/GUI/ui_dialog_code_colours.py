...
class Ui_Dialog_code_colors(object):
    def setupUi(self, Dialog_code_colors):
        ...
        self.label.setGeometry(QtCore.QRect(0, 10, 911, 31))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 447, 538))
    ...
    def retranslateUi(self, Dialog_code_colors):
        ...
        self.label.setText(_translate("Dialog_code_colors", "Colour scheme for codes. Select colours  in order, select codes. Categories ignored."))
