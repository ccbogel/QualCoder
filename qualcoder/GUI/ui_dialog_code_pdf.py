...
class Ui_Dialog_code_pdf(object):
    def setupUi(self, Dialog_code_pdf):
        ...
        self.pushButton_show_selected_code = QtWidgets.QPushButton(parent=self.groupBox_coding_buttons)
        self.pushButton_show_selected_code.setGeometry(QtCore.QRect(50, 0, 28, 28))
        self.pushButton_show_selected_code.setText("")
        self.pushButton_show_selected_code.setObjectName("pushButton_show_selected_code")
        ...
        Dialog_code_pdf.setTabOrder(self.treeWidget, self.pushButton_show_selected_code)
        Dialog_code_pdf.setTabOrder(self.pushButton_show_selected_code, self.pushButton_show_all_codings)
...
"<p>Right-click to change automatic searching options</p></body></html>"))
        ...
        self.pushButton_show_selected_code.setToolTip(_translate("Dialog_code_pdf", "<html><head/><body><p>Show selected_code</p></body></html>"))
