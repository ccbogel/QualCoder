...
class Ui_Dialog_code_pdf(object):
    def setupUi(self, Dialog_code_pdf):
        ...
        self.label_coder.setGeometry(QtCore.QRect(10, 0, 211, 28))
        ...
        self.label_font_size.setGeometry(QtCore.QRect(290, 2, 24, 24))
        ...
        self.spinBox_font_size.setGeometry(QtCore.QRect(320, 0, 53, 30))
        ...
        self.checkBox_black_text.setGeometry(QtCore.QRect(770, 6, 141, 26))
        ...
        Dialog_code_pdf.setTabOrder(self.spinBox_font_size, self.pushButton_help)
...
"<p>Right-click to change automatic searching options</p></body></html>"))
        ...
        self.label_font_size.setToolTip(_translate("Dialog_code_pdf", "<html><head/><body><p>Text font size.</p><p>A default size can be set in Settings.</p></body></html>"))
        self.spinBox_font_size.setToolTip(_translate("Dialog_code_pdf", "<html><head/><body><p>Text font size</p></body></html>"))
        ...
        self.checkBox_black_text.setText(_translate("Dialog_code_pdf", "Black/White Text"))
