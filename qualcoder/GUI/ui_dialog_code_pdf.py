...
class Ui_Dialog_code_pdf(object):
    def setupUi(self, Dialog_code_pdf):
        ...
        self.label_font_size.setGeometry(QtCore.QRect(320, 3, 24, 24))
        ...
        self.label_pages.setGeometry(QtCore.QRect(227, 2, 51, 26))
        ...
        self.comboBox_fontsize.setGeometry(QtCore.QRect(352, 2, 61, 26))
        ...
        self.pushButton_next_page.setGeometry(QtCore.QRect(280, 0, 30, 28))
...
"<p>Right-click to change automatic searching options</p></body></html>"))
        ...
        self.pushButton_previous_page.setToolTip(_translate("Dialog_code_pdf", "<html><head/><body><p><br/></p></body></html>"))
        self.pushButton_next_page.setToolTip(_translate("Dialog_code_pdf", "<html><head/><body><p><br/></p></body></html>"))
