...
class Ui_Dialog_code_text(object):
    def setupUi(self, Dialog_code_text):
        ...
        self.pushButton_delete_all_codes.setGeometry(QtCore.QRect(740, 0, 28, 28))
        ...
        self.pushButton_help.setGeometry(QtCore.QRect(880, 0, 28, 28))
        ...
        self.label_editing = QtWidgets.QLabel(Dialog_code_text)
        self.label_editing.setEnabled(True)
        self.label_editing.setMaximumSize(QtCore.QSize(16777215, 80))
        self.label_editing.setText("")
        self.label_editing.setWordWrap(True)
        self.label_editing.setObjectName("label_editing")
        self.gridLayout_2.addWidget(self.label_editing, 1, 0, 1, 1)
