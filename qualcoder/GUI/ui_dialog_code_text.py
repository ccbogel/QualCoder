...
class Ui_Dialog_code_text(object):
    def setupUi(self, Dialog_code_text):
        ...
        self.splitter = QtWidgets.QSplitter(parent=Dialog_code_text)
        ...
        Dialog_code_text.setTabOrder(self.comboBox_export, self.treeWidget)
        Dialog_code_text.setTabOrder(self.treeWidget, self.pushButton_show_codings_prev)
        Dialog_code_text.setTabOrder(self.pushButton_show_codings_prev, self.pushButton_show_codings_next)
        Dialog_code_text.setTabOrder(self.pushButton_show_codings_next, self.pushButton_show_all_codings)
        Dialog_code_text.setTabOrder(self.pushButton_show_all_codings, self.pushButton_important)
        Dialog_code_text.setTabOrder(self.pushButton_important, self.textEdit)
        Dialog_code_text.setTabOrder(self.textEdit, self.pushButton_code_rule)
        Dialog_code_text.setTabOrder(self.pushButton_code_rule, self.pushButton_journal)
        Dialog_code_text.setTabOrder(self.pushButton_journal, self.pushButton_project_memo)
        Dialog_code_text.setTabOrder(self.pushButton_project_memo, self.textEdit_info)
        Dialog_code_text.setTabOrder(self.textEdit_info, self.pushButton_exit_edit)
