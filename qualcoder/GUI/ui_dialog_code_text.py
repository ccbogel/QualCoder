...
class Ui_Dialog_code_text(object):
    def setupUi(self, Dialog_code_text):
        ...
        self.pushButton_auto_code.setGeometry(QtCore.QRect(870, 0, 36, 36))
        ...
        self.lineEdit_search.setGeometry(QtCore.QRect(350, 0, 191, 32))
        self.lineEdit_search.setObjectName("lineEdit_search")
        self.checkBox_search_case = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_search_case.setGeometry(QtCore.QRect(550, 0, 21, 36))
        ...
        self.checkBox_search_all_files.setGeometry(QtCore.QRect(610, 0, 21, 36))
        ...
        self.label_search_totals.setGeometry(QtCore.QRect(770, 2, 81, 22))
        ...
        self.label_search_case_sensitive.setGeometry(QtCore.QRect(570, 0, 34, 34))
        ...
        self.pushButton_auto_code_frag_this_file.setGeometry(QtCore.QRect(910, 0, 36, 36))
        ...
        self.pushButton_auto_code_frag_all_files.setGeometry(QtCore.QRect(950, 0, 36, 36))
        ...
        self.pushButton_auto_code_undo.setGeometry(QtCore.QRect(990, 0, 36, 36))
        self.pushButton_auto_code_undo.setText("")
        self.pushButton_auto_code_undo.setObjectName("pushButton_auto_code_undo")
        self.pushButton_next_file = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_next_file.setGeometry(QtCore.QRect(10, 0, 36, 36))
        self.pushButton_next_file.setText("")
        self.pushButton_next_file.setObjectName("pushButton_next_file")
        self.pushButton_latest = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_latest.setGeometry(QtCore.QRect(50, 0, 36, 36))
        self.pushButton_latest.setText("")
        self.pushButton_latest.setObjectName("pushButton_latest")
        self.pushButton_bookmark_go = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_bookmark_go.setGeometry(QtCore.QRect(90, 0, 36, 36))
        ...
        self.pushButton_show_codings_next = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_show_codings_next.setGeometry(QtCore.QRect(230, 0, 36, 36))
        self.pushButton_show_codings_next.setText("")
        self.pushButton_show_codings_next.setObjectName("pushButton_show_codings_next")
        self.pushButton_show_codings_prev = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_show_codings_prev.setGeometry(QtCore.QRect(190, 0, 36, 36))
        self.pushButton_show_codings_prev.setText("")
        self.pushButton_show_codings_prev.setObjectName("pushButton_show_codings_prev")
        self.pushButton_show_all_codings = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_show_all_codings.setGeometry(QtCore.QRect(270, 0, 36, 36))
        self.pushButton_show_all_codings.setText("")
        self.pushButton_show_all_codings.setObjectName("pushButton_show_all_codings")
        self.pushButton_document_memo = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_document_memo.setGeometry(QtCore.QRect(130, 0, 36, 36))
        ...
        self.pushButton_annotate.setGeometry(QtCore.QRect(480, 80, 36, 36))
        ...
        self.pushButton_coding_memo.setGeometry(QtCore.QRect(520, 80, 36, 36))
