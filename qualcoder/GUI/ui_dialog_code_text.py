...
class Ui_Dialog_code_text(object):
    def setupUi(self, Dialog_code_text):
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(Dialog_code_text)
        ...
        self.gridLayout_2.addWidget(self.groupBox_edit_mode, 1, 0, 1, 1)
        ...
        Dialog_code_text.setTabOrder(self.comboBox_export, self.listWidget)
        Dialog_code_text.setTabOrder(self.listWidget, self.pushButton_next_file)
        Dialog_code_text.setTabOrder(self.pushButton_next_file, self.pushButton_latest)
        Dialog_code_text.setTabOrder(self.pushButton_latest, self.pushButton_bookmark_go)
        Dialog_code_text.setTabOrder(self.pushButton_bookmark_go, self.pushButton_document_memo)
        Dialog_code_text.setTabOrder(self.pushButton_document_memo, self.pushButton_file_attributes)
        Dialog_code_text.setTabOrder(self.pushButton_file_attributes, self.treeWidget)
