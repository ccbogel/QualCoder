...
class Ui_Dialog_code_text(object):
    def setupUi(self, Dialog_code_text):
        ...
        self.spinBox_font_size = QtWidgets.QSpinBox(parent=self.groupBox)
        self.spinBox_font_size.setGeometry(QtCore.QRect(440, 0, 53, 30))
        ...
        Dialog_code_text.setTabOrder(self.pushButton_show_memos, self.spinBox_font_size)
        Dialog_code_text.setTabOrder(self.spinBox_font_size, self.pushButton_auto_code)
