...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 787, 755))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.doubleSpinBox_ai_temperature = QtWidgets.QDoubleSpinBox(parent=self.widget_2)
        self.doubleSpinBox_ai_temperature.setDecimals(1)
        self.doubleSpinBox_ai_temperature.setMaximum(2.0)
        self.doubleSpinBox_ai_temperature.setSingleStep(0.1)
        self.doubleSpinBox_ai_temperature.setObjectName("doubleSpinBox_ai_temperature")
        self.horizontalLayout_4.addWidget(self.doubleSpinBox_ai_temperature)
        self.label_9 = QtWidgets.QLabel(parent=self.widget_2)
        self.label_9.setObjectName("label_9")
        self.horizontalLayout_4.addWidget(self.label_9)
        self.doubleSpinBox_top_p = QtWidgets.QDoubleSpinBox(parent=self.widget_2)
        self.doubleSpinBox_top_p.setDecimals(1)
        self.doubleSpinBox_top_p.setMaximum(1.0)
        self.doubleSpinBox_top_p.setSingleStep(0.1)
        self.doubleSpinBox_top_p.setProperty("value", 1.0)
        self.doubleSpinBox_top_p.setObjectName("doubleSpinBox_top_p")
        self.horizontalLayout_4.addWidget(self.doubleSpinBox_top_p)
...
""))
        ...
        self.doubleSpinBox_ai_temperature.setToolTip(_translate("Dialog_settings", "Advanced option. Only change when you know whatr you are doing."))
        self.label_9.setText(_translate("Dialog_settings", "   Top_p:"))
        self.doubleSpinBox_top_p.setToolTip(_translate("Dialog_settings", "Advanced option. Only change when you know whatr you are doing."))
