...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(560, 520, 201, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.lineEdit_coderName = QtWidgets.QLineEdit(Dialog_settings)
        self.lineEdit_coderName.setGeometry(QtCore.QRect(190, 80, 241, 30))
        ...
        self.fontComboBox.setGeometry(QtCore.QRect(20, 220, 271, 32))
        self.fontComboBox.setObjectName("fontComboBox")
        self.spinBox = QtWidgets.QSpinBox(Dialog_settings)
        self.spinBox.setGeometry(QtCore.QRect(300, 220, 71, 32))
        ...
        self.label_directory.setGeometry(QtCore.QRect(30, 560, 731, 21))
        self.label_directory.setObjectName("label_directory")
        self.pushButton_choose_directory = QtWidgets.QPushButton(Dialog_settings)
        self.pushButton_choose_directory.setGeometry(QtCore.QRect(30, 520, 391, 30))
        ...
        self.comboBox_coders.setGeometry(QtCore.QRect(190, 40, 241, 30))
        self.comboBox_coders.setObjectName("comboBox_coders")
        self.label_3 = QtWidgets.QLabel(Dialog_settings)
        self.label_3.setGeometry(QtCore.QRect(20, 260, 271, 30))
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName("label_3")
        self.spinBox_treefontsize = QtWidgets.QSpinBox(Dialog_settings)
        self.spinBox_treefontsize.setGeometry(QtCore.QRect(300, 260, 71, 32))
        ...
        self.comboBox_language.setGeometry(QtCore.QRect(180, 146, 191, 32))
        self.comboBox_language.setObjectName("comboBox_language")
        self.checkBox_auto_backup = QtWidgets.QCheckBox(Dialog_settings)
        self.checkBox_auto_backup.setGeometry(QtCore.QRect(10, 408, 761, 21))
        ...
        self.checkBox_backup_AV_files.setGeometry(QtCore.QRect(10, 437, 761, 71))
        ...
        self.label_7.setGeometry(QtCore.QRect(20, 300, 271, 30))
        self.label_7.setWordWrap(True)
        self.label_7.setObjectName("label_7")
        self.spinBox_docfontsize = QtWidgets.QSpinBox(Dialog_settings)
        self.spinBox_docfontsize.setGeometry(QtCore.QRect(300, 300, 71, 32))
        ...
        self.label_backups_to_keep.setGeometry(QtCore.QRect(20, 370, 141, 28))
        ...
        self.spinBox_backups.setGeometry(QtCore.QRect(180, 370, 48, 30))
        ...
        self.pushButton_set_coder.setGeometry(QtCore.QRect(440, 80, 89, 30))
        ...
        self.line_2.setGeometry(QtCore.QRect(20, 350, 751, 16))
        ...
        self.comboBox_text_chunk_size.setGeometry(QtCore.QRect(640, 229, 91, 30))
