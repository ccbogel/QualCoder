...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -132, 795, 733))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget_3 = QtWidgets.QWidget(parent=self.widget_ai)
        ...
        self.widget_2 = QtWidgets.QWidget(parent=self.widget_ai)
