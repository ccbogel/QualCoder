...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        Dialog_settings.resize(627, 578)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog_settings)
        self.buttonBox.setGeometry(QtCore.QRect(270, 537, 261, 32))
        ...
        self.pushButton_choose_directory.setGeometry(QtCore.QRect(30, 467, 391, 31))
        ...
        self.checkBox_auto_backup.setGeometry(QtCore.QRect(30, 344, 900, 23))
        ...
        self.checkBox_backup_AV_files.setGeometry(QtCore.QRect(30, 377, 601, 81))
