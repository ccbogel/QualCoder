...
class Ui_Dialog_settings(object):
    def setupUi(self, Dialog_settings):
        ...
        Dialog_settings.resize(860, 636)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog_settings)
        self.buttonBox.setGeometry(QtCore.QRect(400, 580, 261, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Cancel|QtWidgets.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.lineEdit_coderName = QtWidgets.QLineEdit(Dialog_settings)
        self.lineEdit_coderName.setGeometry(QtCore.QRect(200, 37, 241, 31))
        self.lineEdit_coderName.setObjectName("lineEdit_coderName")
        self.label_new_coder = QtWidgets.QLabel(Dialog_settings)
        self.label_new_coder.setGeometry(QtCore.QRect(10, 43, 171, 21))
        self.label_new_coder.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.checkBox.setGeometry(QtCore.QRect(370, 220, 151, 22))
        self.checkBox.setObjectName("checkBox")
        self.label_directory = QtWidgets.QLabel(Dialog_settings)
        self.label_directory.setGeometry(QtCore.QRect(30, 560, 671, 21))
        ...
        self.label_2.setGeometry(QtCore.QRect(15, 90, 161, 20))
        self.label_2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_2.setObjectName("label_2")
        self.comboBox_coders = QtWidgets.QComboBox(Dialog_settings)
        self.comboBox_coders.setGeometry(QtCore.QRect(200, 80, 241, 32))
        ...
        self.label_4.setGeometry(QtCore.QRect(25, 160, 151, 20))
        self.label_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName("label_4")
        self.comboBox_language = QtWidgets.QComboBox(Dialog_settings)
        self.comboBox_language.setGeometry(QtCore.QRect(200, 150, 241, 32))
        ...
        self.checkBox_backup_AV_files.setGeometry(QtCore.QRect(10, 417, 671, 91))
        ...
        self.checkBox_dark_mode.setGeometry(QtCore.QRect(370, 250, 191, 23))
        ...
        self.label_current_coder.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_current_coder.setObjectName("label_current_coder")
        self.label_8 = QtWidgets.QLabel(Dialog_settings)
        self.label_8.setGeometry(QtCore.QRect(470, 385, 141, 23))
...
"You must store these files elsewhere."))
        ...
        self.label_8.setText(_translate("Dialog_settings", "Backups"))
