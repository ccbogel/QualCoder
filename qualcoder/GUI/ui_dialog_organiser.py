...
class Ui_DialogOrganiser(object):
    def setupUi(self, DialogOrganiser):
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(324, 3, 28, 28))
        ...
        self.pushButton_clear.setGeometry(QtCore.QRect(353, 3, 28, 28))
        self.pushButton_clear.setText("")
        self.pushButton_clear.setObjectName("pushButton_clear")
        self.label_loaded_graph = QtWidgets.QLabel(parent=self.groupBox_header)
        self.label_loaded_graph.setGeometry(QtCore.QRect(400, 2, 531, 28))
        ...
        self.pushButton_apply.setGeometry(QtCore.QRect(230, 3, 91, 28))
        ...
        DialogOrganiser.setTabOrder(self.pushButton_export, self.pushButton_clear)
        DialogOrganiser.setTabOrder(self.pushButton_clear, self.graphicsView)
    ...
    def retranslateUi(self, DialogOrganiser):
        ...
        self.pushButton_clear.setToolTip(_translate("DialogOrganiser", "Clear"))
