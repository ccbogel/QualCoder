...
class Ui_DialogCharts(object):
    def setupUi(self, DialogCharts):
        ...
        self.comboBox_wordclouds = QtWidgets.QComboBox(parent=DialogCharts)
        self.comboBox_wordclouds.setGeometry(QtCore.QRect(410, 430, 321, 25))
        self.comboBox_wordclouds.setObjectName("comboBox_wordclouds")
        ...
        self.comboBox_wordclouds.raise_()
...
"Codings from the entire text file are used for the calculations."))
        ...
        self.label_word_clouds.setText(_translate("DialogCharts", "Word clouds"))
