...
class Ui_DialogCharts(object):
    def setupUi(self, DialogCharts):
        ...
        self.pushButton_wordcloud.setGeometry(QtCore.QRect(581, 481, 121, 51))
        ...
        self.label_reverse_range.setGeometry(QtCore.QRect(410, 490, 151, 16))
        self.label_reverse_range.setObjectName("label_reverse_range")
        self.label_trigrams = QtWidgets.QLabel(parent=DialogCharts)
        self.label_trigrams.setGeometry(QtCore.QRect(410, 510, 151, 16))
        self.label_trigrams.setObjectName("label_trigrams")
        self.checkBox_trigrams = QtWidgets.QCheckBox(parent=DialogCharts)
        self.checkBox_trigrams.setGeometry(QtCore.QRect(380, 510, 21, 20))
        self.checkBox_trigrams.setObjectName("checkBox_trigrams")
        ...
        self.label_trigrams.raise_()
        self.checkBox_trigrams.raise_()
...
"wordcloud"))
        ...
        self.checkBox_reverse_range.setToolTip(_translate("DialogCharts", "<html><head/><body><p>Reverse colour range</p></body></html>"))
        self.label_reverse_range.setText(_translate("DialogCharts", "Reverse range"))
        self.label_trigrams.setText(_translate("DialogCharts", "Trigrams"))
        self.checkBox_trigrams.setToolTip(_translate("DialogCharts", "<html><head/><body><p>Reverse colour range</p></body></html>"))
        self.checkBox_trigrams.setText(_translate("DialogCharts", "Tri-grams"))
