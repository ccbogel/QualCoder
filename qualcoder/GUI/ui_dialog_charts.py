...
class Ui_DialogCharts(object):
    def setupUi(self, DialogCharts):
        ...
        self.label_filters.setGeometry(QtCore.QRect(410, 50, 291, 22))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_chart_options_2.setGeometry(QtCore.QRect(10, 260, 261, 22))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBox_heatmaps = QtWidgets.QGroupBox(DialogCharts)
        self.groupBox_heatmaps.setGeometry(QtCore.QRect(10, 260, 321, 61))
        self.groupBox_heatmaps.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.groupBox_heatmaps.setTitle("")
        self.groupBox_heatmaps.setObjectName("groupBox_heatmaps")
        self.radioButton_heatmap_file = QtWidgets.QRadioButton(self.groupBox_heatmaps)
        self.radioButton_heatmap_file.setGeometry(QtCore.QRect(0, 30, 112, 23))
        self.radioButton_heatmap_file.setChecked(True)
        self.radioButton_heatmap_file.setObjectName("radioButton_heatmap_file")
        self.radioButton_heatmap_case = QtWidgets.QRadioButton(self.groupBox_heatmaps)
        self.radioButton_heatmap_case.setGeometry(QtCore.QRect(120, 30, 112, 23))
        self.radioButton_heatmap_case.setObjectName("radioButton_heatmap_case")
        self.pushButton_heatmap = QtWidgets.QPushButton(self.groupBox_heatmaps)
        self.pushButton_heatmap.setGeometry(QtCore.QRect(270, 26, 28, 28))
        self.pushButton_heatmap.setText("")
        self.pushButton_heatmap.setObjectName("pushButton_heatmap")
        self.line_4 = QtWidgets.QFrame(DialogCharts)
        self.line_4.setGeometry(QtCore.QRect(10, 240, 331, 16))
        self.line_4.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_4.setObjectName("line_4")
        self.groupBox.raise_()
        self.groupBox_heatmaps.raise_()
...
"Codings from the entire text file are used for the calculations."))
        ...
        self.radioButton_heatmap_file.setText(_translate("DialogCharts", "File"))
        self.radioButton_heatmap_case.setText(_translate("DialogCharts", "Case"))
