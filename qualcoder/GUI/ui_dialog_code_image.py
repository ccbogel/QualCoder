...
class Ui_Dialog_code_image(object):
    def setupUi(self, Dialog_code_image):
        ...
        Dialog_code_image.resize(950, 630)
        ...
        self.pushButton_memo.setGeometry(QtCore.QRect(20, 7, 36, 36))
        ...
        self.checkBox_show_coders.setGeometry(QtCore.QRect(700, 0, 221, 22))
        self.checkBox_show_coders.setObjectName("checkBox_show_coders")
        self.label_code = QtWidgets.QLabel(self.groupBox_2)
        self.label_code.setGeometry(QtCore.QRect(20, 50, 441, 26))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 467, 454))
