...
class Ui_Dialog_cases(object):
    def setupUi(self, Dialog_cases):
        ...
        self.pushButton_add.setGeometry(QtCore.QRect(10, 0, 201, 32))
        self.pushButton_add.setObjectName("pushButton_add")
        self.pushButton_delete = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_delete.setGeometry(QtCore.QRect(750, 0, 211, 32))
        self.pushButton_delete.setObjectName("pushButton_delete")
        self.pushButton_import_cases = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_import_cases.setGeometry(QtCore.QRect(230, 0, 231, 32))
        ...
        self.pushButton_add_attribute.setGeometry(QtCore.QRect(480, 0, 231, 31))
