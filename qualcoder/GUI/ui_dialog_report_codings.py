...
class Ui_Dialog_reportCodings(object):
    def setupUi(self, Dialog_reportCodings):
        ...
        self.pushButton_caseselect.setGeometry(QtCore.QRect(240, 50, 191, 27))
        ...
        self.pushButton_fileselect.setGeometry(QtCore.QRect(240, 20, 191, 27))
        ...
        self.pushButton_search.setGeometry(QtCore.QRect(450, 20, 121, 27))
        ...
        self.pushButton_attributeselect.setGeometry(QtCore.QRect(240, 80, 191, 27))
        ...
        self.label_exports.setGeometry(QtCore.QRect(450, 60, 131, 16))
        self.label_exports.setObjectName("label_exports")
        self.comboBox_export = QtWidgets.QComboBox(self.groupBox)
        self.comboBox_export.setGeometry(QtCore.QRect(450, 80, 91, 25))
    ...
    def retranslateUi(self, Dialog_reportCodings):
        ...
        self.pushButton_caseselect.setText(_translate("Dialog_reportCodings", "Cases"))
        self.pushButton_fileselect.setText(_translate("Dialog_reportCodings", "Files"))
