...
class Ui_Dialog_reportCodings(object):
    def setupUi(self, Dialog_reportCodings):
        ...
        self.label_counts.setGeometry(QtCore.QRect(430, 44, 161, 60))
        self.label_counts.setMinimumSize(QtCore.QSize(0, 60))
        self.label_counts.setMaximumSize(QtCore.QSize(16777215, 60))
        ...
        self.comboBox_memos.setGeometry(QtCore.QRect(640, 70, 151, 30))
