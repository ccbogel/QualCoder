...
class Ui_Dialog_reportCodings(object):
    def setupUi(self, Dialog_reportCodings):
        ...
        self.label_exports.setGeometry(QtCore.QRect(280, 84, 24, 24))
        ...
        self.comboBox_export.setGeometry(QtCore.QRect(310, 81, 91, 30))
        ...
        self.comboBox_sort.setGeometry(QtCore.QRect(50, 80, 91, 30))
    ...
    def retranslateUi(self, Dialog_reportCodings):
        ...
        self.comboBox_sort.setToolTip(_translate("Dialog_reportCodings", "<html><head/><body><p>Results sort order</p></body></html>"))
        self.comboBox_sort.setItemText(1, _translate("Dialog_reportCodings", "html"))
        self.comboBox_sort.setItemText(2, _translate("Dialog_reportCodings", "txt"))
        self.comboBox_sort.setItemText(3, _translate("Dialog_reportCodings", "odt"))
        self.comboBox_sort.setItemText(4, _translate("Dialog_reportCodings", "csv"))
