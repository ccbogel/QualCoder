...
class Ui_Dialog_CodeRelations(object):
    def setupUi(self, Dialog_CodeRelations):
        ...
        self.pushButton_export_exact = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_export_exact.setGeometry(QtCore.QRect(750, 30, 28, 28))
        self.pushButton_export_exact.setObjectName("pushButton_export_exact")
        self.line = QtWidgets.QFrame(self.groupBox)
        self.line.setGeometry(QtCore.QRect(735, 10, 10, 71))
    ...
    def retranslateUi(self, Dialog_CodeRelations):
        ...
        self.pushButton_export_exact.setToolTip(_translate("Dialog_CodeRelations", "<html><head/><body><p>Export Excel report of exact text coding matches for all  files.</p><p>Ordered by file name and code name.</p></body></html>"))
