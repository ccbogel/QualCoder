...
class Ui_Dialog_CodeRelations(object):
    def setupUi(self, Dialog_CodeRelations):
        ...
        self.pushButton_exportcsv.setGeometry(QtCore.QRect(450, 30, 28, 28))
        ...
        self.pushButton_summary_stats = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_summary_stats.setGeometry(QtCore.QRect(400, 30, 28, 28))
        self.pushButton_summary_stats.setText("")
        self.pushButton_summary_stats.setObjectName("pushButton_summary_stats")
        ...
        self.label_statistics = QtWidgets.QLabel(Dialog_CodeRelations)
        self.label_statistics.setMinimumSize(QtCore.QSize(0, 26))
        self.label_statistics.setMaximumSize(QtCore.QSize(16777215, 26))
        self.label_statistics.setObjectName("label_statistics")
        self.verticalLayout.addWidget(self.label_statistics)
        self.tableWidget_statistics = QtWidgets.QTableWidget(Dialog_CodeRelations)
        ...
        self.verticalLayout.addWidget(self.tableWidget_statistics)
    ...
    def retranslateUi(self, Dialog_CodeRelations):
        ...
        self.pushButton_summary_stats.setToolTip(_translate("Dialog_CodeRelations", "Summary statistics"))
        self.label_codes.setText(_translate("Dialog_CodeRelations", "Codes:"))
        self.label_statistics.setText(_translate("Dialog_CodeRelations", "Summary statistics for coding distance"))
