...
class Ui_Dialog_CodeRelations(object):
    ...
    def retranslateUi(self, Dialog_CodeRelations):
        ...
        self.pushButton_exportcsv.setText(_translate("Dialog_CodeRelations", "Export csv file"))
        self.pushButton_calculate.setText(_translate("Dialog_CodeRelations", "Calculate"))
