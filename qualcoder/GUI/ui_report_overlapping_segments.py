...
class Ui_DialogOverlappingTextSegments(object):
    def setupUi(self, DialogOverlappingTextSegments):
        ...
        self.comboBox_coders.setGeometry(QtCore.QRect(430, 60, 171, 26))
        ...
        self.label_coder.setGeometry(QtCore.QRect(320, 60, 111, 28))
    ...
    def retranslateUi(self, DialogOverlappingTextSegments):
        ...
        self.label_title.setText(_translate("DialogOverlappingTextSegments", "<b>Overlapping text segments report</b>"))
        ...
        self.label_instructions.setText(_translate("DialogOverlappingTextSegments", "Select 1 file, 1 coder. Select 2 or more codes. Can exclude results by excluding an overlapping code."))
