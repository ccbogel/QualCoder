...
class Ui_Dialog_manage_attributes(object):
    def setupUi(self, Dialog_manage_attributes):
        ...
        self.pushButton_add.setGeometry(QtCore.QRect(30, 0, 36, 36))
        self.pushButton_add.setText("")
        self.pushButton_add.setObjectName("pushButton_add")
        self.pushButton_delete = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_delete.setGeometry(QtCore.QRect(120, 0, 36, 36))
        self.pushButton_delete.setText("")
        self.pushButton_delete.setObjectName("pushButton_delete")
        self.label = QtWidgets.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(190, 6, 281, 26))
        self.label.setText("")
