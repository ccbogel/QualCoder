...
class Ui_Dialog_Import(object):
    def setupUi(self, Dialog_Import):
        ...
        self.checkBox.setGeometry(QtCore.QRect(600, 31, 321, 31))
    ...
    def retranslateUi(self, Dialog_Import):
        ...
        self.checkBox.setToolTip(_translate("Dialog_Import", "<html><head/><body><p>If checked: All the rows of a qualitative column will be collated into one text file.</p><p>If unchecked: Each qualtiatve answer will be an individual text file within the database.</p></body></html>"))
        self.checkBox.setText(_translate("Dialog_Import", "One file per qualitative column"))
