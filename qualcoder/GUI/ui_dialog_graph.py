...
class Ui_DialogGraph(object):
    def setupUi(self, DialogGraph):
        ...
        self.label_loaded_graph.setGeometry(QtCore.QRect(520, 2, 481, 28))
        ...
        self.pushButton_memos_of_file = QtWidgets.QPushButton(self.groupBox_header)
        ...
        self.pushButton_codes_of_images = QtWidgets.QPushButton(self.groupBox_header)
        ...
        self.pushButton_codes_of_av = QtWidgets.QPushButton(self.groupBox_header)
