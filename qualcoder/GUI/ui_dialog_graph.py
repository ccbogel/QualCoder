...
class Ui_DialogGraph(object):
    def setupUi(self, DialogGraph):
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(830, 6, 28, 28))
        ...
        self.label_zoom.setGeometry(QtCore.QRect(870, 7, 28, 28))
        ...
        self.pushButton_reveal.setGeometry(QtCore.QRect(190, 40, 28, 28))
        self.pushButton_reveal.setText("")
        self.pushButton_reveal.setObjectName("pushButton_reveal")
        self.pushButton_file = QtWidgets.QPushButton(self.groupBox_header)
        self.pushButton_file.setGeometry(QtCore.QRect(230, 40, 28, 28))
    ...
    def retranslateUi(self, DialogGraph):
        ...
        self.pushButton_file.setToolTip(_translate("DialogGraph", "Show selected files"))
