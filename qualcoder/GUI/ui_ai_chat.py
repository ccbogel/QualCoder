...
class Ui_Dialog_ai_chat(object):
    def setupUi(self, Dialog_ai_chat):
        ...
        self.scrollArea_ai_output_contents.setGeometry(QtCore.QRect(0, 0, 664, 461))
        ...
        self.gridLayout_2.addWidget(self.plainTextEdit_question, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_question, 2, 1, 1, 1)
