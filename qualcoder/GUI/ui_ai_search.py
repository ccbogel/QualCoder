...
class Ui_Dialog_AiSearch(object):
    def setupUi(self, Dialog_AiSearch):
        ...
        self.splitter_2 = QtWidgets.QSplitter(parent=self.groupBox_2)
        self.splitter_2.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter_2.setOpaqueResize(True)
        self.splitter_2.setChildrenCollapsible(False)
        self.splitter_2.setObjectName("splitter_2")
        self.widget_what = QtWidgets.QWidget(parent=self.splitter_2)
        ...
        self.widget_where = QtWidgets.QWidget(parent=self.splitter_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.splitter = QtWidgets.QSplitter(parent=self.widget_case_files)
        self.splitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.splitter.setChildrenCollapsible(False)
        self.splitter.setObjectName("splitter")
        self.listWidget_files = QtWidgets.QListWidget(parent=self.splitter)
        self.listWidget_files.setObjectName("listWidget_files")
        self.listWidget_cases = QtWidgets.QListWidget(parent=self.splitter)
